    ...
    static {
        ...
        map.put(key(ProtocolType.CLAUDE_MESSAGES, ProtocolType.AWS_BEDROCK_CLAUDE_MESSAGES,
                ...
                detailedMapping("tools", "tools",
                        "支持的自定义工具、memory 和 tool search 定义保留；StructuredOutput 的非 object 根 schema 在 Bedrock 侧包装并在响应侧解包；Claude Code 收口重试会指定 StructuredOutput 并关闭 thinking",
                        MappingLossiness.NONE, "TOOL", "TRANSFORM", "array", "array",
                        null, null, "Bedrock 要求自定义工具 input_schema.type=object"),
